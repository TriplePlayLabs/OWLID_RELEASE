...
export class Contract {
      ...
      attestEmailVerified: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('attestEmailVerified',
                                     ...
                                     'predicate_email.compact line 34 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(rootHash_0),
      ...
      isAttested: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('isAttested',
                                     'argument 1 (as invoked from Typescript)',
                                     'predicate_email.compact line 46 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      pause: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('pause',
                                     'argument 1 (as invoked from Typescript)',
                                     'predicate_email.compact line 50 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      unpause: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('unpause',
                                     'argument 1 (as invoked from Typescript)',
                                     'predicate_email.compact line 51 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      transferOwnership: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('transferOwnership',
                                     'argument 1 (as invoked from Typescript)',
                                     'predicate_email.compact line 52 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      owner: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('owner',
                                     'argument 1 (as invoked from Typescript)',
                                     'predicate_email.compact line 55 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      isPaused: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('isPaused',
                                     'argument 1 (as invoked from Typescript)',
                                     'predicate_email.compact line 56 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(initialOwner_0) === 'object' && typeof(initialOwner_0.is_left) === 'boolean' && typeof(initialOwner_0.left) === 'object' && initialOwner_0.left.bytes.buffer instanceof ArrayBuffer && initialOwner_0.left.bytes.BYTES_PER_ELEMENT === 1 && initialOwner_0.left.bytes.length === 32 && typeof(initialOwner_0.right) === 'object' && initialOwner_0.right.bytes.buffer instanceof ArrayBuffer && initialOwner_0.right.bytes.BYTES_PER_ELEMENT === 1 && initialOwner_0.right.bytes.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'predicate_email.compact line 18 char 1',
                                 'struct Either<is_left: Boolean, left: struct ZswapCoinPublicKey<bytes: Bytes<32>>, right: struct ContractAddress<bytes: Bytes<32>>>',
                                 initialOwner_0)
    }
  ...
  _attestEmailVerified_0(context, partialProofData, rootHash_0) {
    this._assertNotPaused_0(context, partialProofData);
      ...
      checkRoot(...args_0) {
        ...
        if (!(typeof(rt_0) === 'object' && typeof(rt_0.field) === 'bigint' && rt_0.field >= 0 && rt_0.field <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('checkRoot',
                                     'argument 1',
                                     'predicate_email.compact line 15 char 1',
