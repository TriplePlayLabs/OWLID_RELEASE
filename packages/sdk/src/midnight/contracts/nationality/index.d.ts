...
export type Witnesses<PS> = {
  nationalityCode(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
  verifierIdHash(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
  allowedCountryPath(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, { leaf: Uint8Array,
...
export type ImpureCircuits<PS> = {
  attestNationalityIn(context: __compactRuntime.CircuitContext<PS>,
                      rootHash_0: Uint8Array,
                      setHash_0: Uint8Array): __compactRuntime.CircuitResults<PS, []>;
