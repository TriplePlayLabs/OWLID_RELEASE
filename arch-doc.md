...
2. [System Overview](#ii-system-overview)
3. [Architecture Principles and Style](#iii-architecture-principles-and-style)
4. [Component Architecture (C4 Level 2–3)](#iv-component-architecture)
5. [Data Architecture](#v-data-architecture)
6. [Integrations and External Systems](#vi-integrations-and-external-systems)
7. [Non-Functional Requirements](#vii-non-functional-requirements)
8. [Technology Choices](#viii-technology-choices)
9. [Roadmap and Future Vision](#ix-roadmap-and-future-vision)
...
### API Endpoints (Token Verification Service)
